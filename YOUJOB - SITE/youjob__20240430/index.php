              ...
              <div class="card-front">
                <div class="center-wrap">
                  <div class="section text-center">
                    ...
                    <a href="./frontend/home.php" class="btn mt-4">Login</a>
              ...
              <div class="card-back">
                <div class="center-wrap">
                  <div class="section text-center">
                    ...
                    <div class="form-group mt-2">
                      <input type="tel" class="form-style" placeholder="Numero do Telefone">
                      <i class="input-icon uil uil-phone"></i>
                    </div>	
                    <div class="form-group mt-2">
                      <input type="email" class="form-style" placeholder="Email-Constitucional">
                      <i class="input-icon uil uil-at"></i>
                    </div>
                    <div class="form-group mt-2">
                      <input type="password" class="form-style" placeholder="Senha">
                    ...
                    <a href="./frontend/home.php" class="btn mt-4">Registrar-Se</a>
                      </div>
                    </div>
                  </div>
                </div>
